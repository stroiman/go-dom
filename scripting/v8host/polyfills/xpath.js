...
function initXPath(core) {
  ...
  function compareSiblings(a, b) {
    ...
    throw new Error(
      "a and b are not siblings: " +
        xpath.stringifyObject(a) +
        " vs " +
        xpath.stringifyObject(b),
    );
  }
  ...
  function mergeNodeLists(x, y) {
    ...
    if ("object" !== typeof x)
      throw new XPathException(
        XPathException.INVALID_EXPRESSION_ERR,
        "Invalid LHS for | operator " + "(expected node-set): " + x,
      );
    if ("object" !== typeof y)
      throw new XPathException(
        XPathException.INVALID_EXPRESSION_ERR,
        "Invalid LHS for | operator " + "(expected node-set): " + y,
      );
    while (true) {
      if (null == a) {
        a = x.shift();
  ...
  function comparisonHelper(test, x, y, isNumericComparison) {
    ...
    if (isNumericComparison) coersion = fn.number;
      ...
      coersion =
        "boolean" === typeof x || "boolean" === typeof y
          ? fn["boolean"]
  ...
  var axes = (xpath.axes = {
    ...
    "ancestor-or-self": function ancestorOrSelf(
      nodeList /*destructive!*/,
      nodeTypeNum,
      nodeName,
      shouldLowerCase,
    ...
    child: function child(
      ...
      for (var i = 0; i < nodeList.length; ++i) {
        ...
        if (n.childNodes) {
          nodeMultiSet.pushSeries();
          var childList =
            1 === nodeTypeNum && null != n.children ? n.children : n.childNodes;
    ...
    "descendant-or-self": function descenantOrSelf(
      nodeList /*destructive!*/,
      nodeTypeNum,
      nodeName,
      shouldLowerCase,
    ...
    "following-sibling": function followingSibling(
      nodeList /*destructive!*/,
      nodeTypeNum,
      nodeName,
      shouldLowerCase,
    ...
    "preceding-sibling": function precedingSibling(
      nodeList /*destructive!*/,
      nodeTypeNum,
      nodeName,
      shouldLowerCase,
  ...
  var fn = {
    ...
    string: function string(optObject) {
      ...
      if (
        "string" === typeof optObject ||
        "boolean" === typeof optObject ||
      ...
      switch (ast[0]) {
        ...
        case "Axis":
          ...
          var axis = ast[1],
            ...
            nodeName =
              ast[3] && shouldLowerCase ? ast[3].toLowerCase() : ast[3];
   ...
   *                           DOM interface                                 *
   ***************************************************************************/
  var XPathException = (xpath.XPathException = function XPathException(
    code,
    message,
  ) {
  ...
  var XPathExpression = (xpath.XPathExpression = function XPathExpression(
    expression,
    resolver,
    optDoc,
  ) {
  ...
  var XPathResult = (xpath.XPathResult = function XPathResult(
    doc,
    value,
    resultType,
  ) {
  ...
  var proto = {
    ...
    get singleNodeValue() {
      if (
        XPathResult.ANY_UNORDERED_NODE_TYPE !== this.resultType &&
    ...
    get invalidIteratorState() {
      if (
        XPathResult.UNORDERED_NODE_ITERATOR_TYPE !== this.resultType &&
    ...
    get snapshotLength() {
      if (
        XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE !== this.resultType &&
  ...
  XPathResult.prototype = Object.create(
    XPathResult,
